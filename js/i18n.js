...
(function () {
  ...
  const translations = {
    el: {
      ...
      'al_step1_desc': 'Στο πρώτο ραντεβού, ο οδοντίατρος αξιολογεί τη σύγκλεισή σας και αποφασίζει αν οι διάφανοι νάρθηκες είναι η κατάλληλη θεραπεία για εσάς.',
      ...
      'al_faq1_a': 'Η διάρκεια εξαρτάται από την πολυπλοκότητα κάθε περίπτωσης. Τυπικά κυμαίνεται μεταξύ 6 και 18 μηνών. Ο οδοντίατρος θα σας δώσει ακριβή εκτίμηση στην αρχική αξιολόγηση.',
    ...
    en: {
      ...
      'al_step1_desc': 'In the first appointment, the dentist evaluates your occlusion and decides if clear aligners are the appropriate treatment for you.',
      ...
      'al_faq1_a': 'The duration depends on the complexity of each case. It typically ranges between 6 and 18 months. The dentist will give you an exact estimate in the initial evaluation.',
