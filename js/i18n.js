...
(function () {
  ...
  const translations = {
    el: {
      ...
      'desc.about': 'Γνωρίστε τον Άγγελο Μοσχόπουλο, έμπειρο χειρουργό οδοντίατρο στο Παλαιό Φάληρο. Εξειδίκευση σε εμφυτεύματα, αισθητική οδοντιατρική (λεύκανση, όψεις) και διάφανους νάρθηκες Clear Aligners. Δείτε το βιογραφικό του.',
    ...
    en: {
      ...
      'desc.about': 'Meet Dr. Angelo Moshopoulos, an experienced dental surgeon in Paleo Faliro. Specialized in dental implants, aesthetic dentistry (whitening, veneers), and Clear Aligners. View his full biography.',
