...
(function () {
  ...
  const translations = {
    ...
    'desc.faq': 'Συχνές ερωτήσεις για οδοντικά εμφυτεύματα: κόστος, πόνος, διάρκεια και εγγύηση. Ενημερωθείτε υπεύθυνα από την κλινική μας στο Παλαιό Φάληρο.',
      ...
      'about.p1': 'Συνδυάζοντας την επιστημονική αρτιότητα με την ανθρωποκεντρική προσέγγιση, ο Άγγελος Μοσχόπουλος διαθέτει μια πολυδιάστατη ακαδημαϊκή και κλινική διαδρομή. Ξεκίνησε τις σπουδές του στο <strong>Πανεπιστήμιο McGill</strong> του Καναδά, όπου το 1992 ολοκλήρωσε τον κύκλο της Βιολογίας με εξειδίκευση στη Μικροβιολογία και την Ανοσολογία, θέτοντας τις βάσεις για τη βαθιά κατανόηση της βιολογικής απόκρισης των ιστών.',
      'about.p2': 'Η αφοσίωσή του στην έρευνα συνεχίστηκε στο <strong>Ελληνικό Ινστιτούτο Παστέρ</strong>, όπου προσέφερε το έργο του ως ερευνητής επί διετία. Στη συνέχεια, το πάθος του για την κλινική πράξη τον οδήγησε στην Οδοντιατρική, λαμβάνοντας το πτυχίο του από το <strong>Πανεπιστήμιο Semmelweis</strong> το 1999.',
    ...
    'desc.manage': 'Manage your dental appointment at Dentplant Clinic. View details, reschedule, or cancel your appointment easily and quickly through our online portal.',
      ...
      /* ── about.html — biography sections ──────── */
      'about.p1': 'Blending clinical excellence with a patient-centric philosophy, Dr. Angelo Moshopoulos brings a distinguished multi-disciplinary background to modern dentistry. He began his academic journey at <strong>McGill University</strong> in Canada, graduating in 1992 with a degree in Biology, specializing in Microbiology and Immunology—a foundation that provides him with unique insight into the biological complexities of tissue integration.',
      'about.p2': 'His dedication to scientific inquiry continued at the <strong>Hellenic Pasteur Institute</strong>, where he served as a researcher for two years before transitioning to clinical practice. He earned his Doctor of Dental Medicine (DMD) from <strong>Semmelweis University</strong> in 1999, fully committing his expertise to the art and science of dentistry.',
